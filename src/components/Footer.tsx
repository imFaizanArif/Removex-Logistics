      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-5">
            ...
            >
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-amber-600 text-white shadow-lg shadow-amber-900/20">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <span className="text-xl font-bold tracking-tight text-white">REMOVEX LOGISTICS</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-400">
              Trusted UK removals and logistics — house removals, freight, warehousing, 3PL, and rubbish removal. We move your goods safely, securely, and on time.
            </p>
          </div>
